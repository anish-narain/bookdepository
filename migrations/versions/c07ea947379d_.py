...
Revision ID: c07ea947379d
Revises: 
Create Date: 2020-12-16 19:17:53.731366
...
def upgrade():
    ...
    sa.Column('contact_account_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['contact_account_id'], ['user.id'], ),
